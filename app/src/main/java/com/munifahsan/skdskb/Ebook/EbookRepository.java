...
public class EbookRepository implements EbookContract.Repository {
    EbookContract.Listener mListener;
    ...
    public EbookRepository(EbookContract.Listener mEbookListener) {
        this.mListener = mEbookListener;
    }
