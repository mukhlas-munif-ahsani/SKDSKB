...
public class EbookPresenter implements EbookContract.Presenter, EbookContract.Listener{
    public static final String URL_REGEX = "^((https?|ftp)://|(www|ftp)\\.)?[a-z0-9-]+(\\.[a-z0-9-]+)+([/?].*)?$";

    EbookContract.View mView;
    EbookContract.Repository mRepo;

    public EbookPresenter(EbookContract.View mEbookView) {
        this.mView = mEbookView;
        mRepo = new EbookRepository(this);
    }
