...
public class AddEbookRepository implements AddEbookContract.Repository {

    AddEbookContract.Listener mListener;
    ...
    public AddEbookRepository(AddEbookContract.Listener listener) {
        mListener = listener;
    }
