...
public class ListTryoutAdapter extends FirestoreRecyclerAdapter<TryoutModel, ListTryoutAdapter.Holder> {
    /**
    ...
    public ListTryoutAdapter(@NonNull FirestoreRecyclerOptions<TryoutModel> options) {
        super(options);
    }
