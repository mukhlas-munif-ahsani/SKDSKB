...
public class AddVideoRepository implements AddVideoContract.Repository {
    AddVideoContract.Listener mListener;
    ...
    public AddVideoRepository(AddVideoContract.Listener listener) {
        mListener = listener;
    }
