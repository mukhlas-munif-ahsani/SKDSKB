...
public class ListOneAdapter extends FirestoreRecyclerAdapter<MateriModel, ListOneAdapter.Holder> {
    /**
    ...
    public ListOneAdapter(@NonNull FirestoreRecyclerOptions<MateriModel> options) {
        super(options);
    }
