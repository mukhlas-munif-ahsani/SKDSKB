...
public class KategoriMateriAdapter extends FirestoreRecyclerAdapter<KategoriModel, KategoriMateriAdapter.Holder> {
    /**
    ...
    public KategoriMateriAdapter(@NonNull FirestoreRecyclerOptions<KategoriModel> options) {
        super(options);
    }
